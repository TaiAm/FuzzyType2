...
/**
  Create an object of Defuzzification class and initialise the calculateCentriod() as variable (centroidDefvalues) 
   so values are called into TOPSIS class instead of statically assigning it again in line 61
  
  Create an object of Criteria AHP at line 102 and initialise the show_finalEigenvector as a variable
...
public class TOPSIS {
   public double [][] centroidDef =YagersMinMax.centroidDef;
    int nAlt, n;
