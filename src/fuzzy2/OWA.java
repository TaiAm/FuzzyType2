...
public class OWA {
    ...
    public OWA(int nInst, int nCriteria)
    {
    ...
    public static void main(String ... args)
    {
        ...
        int nCriteria = YagersMinMax.centroidDef[0].length, nInst = YagersMinMax.centroidDef.length;
...
//        nInst = key.nextInt();
        ...
        OWA[] objInst = new OWA[nInst];
        for(int i = 0; i<nInst; i++){
            objInst[i] = new OWA(nInst, nCriteria);
...
//        criteriaValue = new double[nInst][nCriteria];
        ...
        weight = CriteriaAHP.comparisons;//weight = criAHP.show_finalEigenvector();
        criteriaValue =YagersMinMax.centroidDef;//criteriaValue = tt.calculateCentroid();
        ...
        for (int i = 0; i < nInst; i++) {
            ...
            form.setTitle("OWA VALUE FOR INSTITUTION "+(i+1));
